...
// Librerías nativas de Windows para HTTP/HTTPS seguro
#include <windows.h>
#include <winhttp.h>
...
//Funcion para el apartado 2: Calculo de adelantos u atrasos en la llegada y almacenamiento de matriculas y tiempos:
...
=======
    cout << "\n¿Desea enviar a la base de datos los resultados? (y/n): ";
>>>>>>> b2ab2d68ec2c0f2035a9bd1400d89fd5eaaa426d
    cin >> opcionGuardar;
